        ...
        <div id="page-wrapper">
            ...
            <table class="table-fill">
                ...
                <tbody class="table-hover">
                    ...
                    <tr>    
                        <td colspan="2"><a href="<?php echo base_url()."index.php/profieluserupdaten";?>" class="btn btn-info" onclick="return confirm('Ben je zeker dat je wil verdergaan?')">Edit</a></td>
                    </tr>
                </tbody>
            </table>
